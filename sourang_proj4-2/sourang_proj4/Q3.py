...
pic_1 = cv2.imread('im0_l.png')
pic_2 = cv2.imread('im1_l.png')
...
F = Ransac_fn(pts1_padded, pts2_padded, threshold= 0.10, inliers=1000)
...
def climax(w1,h1, vmi, vmx, f, b):
    ...
    print(np.max(sq_dist))
    print(np.min(sq_dist))
...
cv2.waitKey(0)
art_room = climax(1920, 1080, 27, 85, 1734.16, 228.38)
